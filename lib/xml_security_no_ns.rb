...
module XMLSecurity
  ...
  class SignedDocumentNoNs < REXML::Document
    ...
    def validate_doc(base64_cert, soft = true)
      ...
      sig_element = REXML::XPath.first(self, "//Signature") #, {"ds"=>"http://www.w3.org/2000/09/xmldsig#"})
      sig_element.remove

      # check digests
      REXML::XPath.each(sig_element, "//Reference") do |ref| #, {"ds"=>"http://www.w3.org/2000/09/xmldsig#"}) 
        ...
        digest_value                  = REXML::XPath.first(ref, "//DigestValue").text #, {"ds"=>"http://www.w3.org/2000/09/xmldsig#"}).text
      ...
      # verify signature
      canoner                 = XML::Util::XmlCanonicalizer.new(false, true)
      signed_info_element     = REXML::XPath.first(sig_element, "//SignedInfo") #, {"ds"=>"http://www.w3.org/2000/09/xmldsig#"})
      canon_string            = canoner.canonicalize(signed_info_element)

      base64_signature        = REXML::XPath.first(sig_element, "//SignatureValue").text #, {"ds"=>"http://www.w3.org/2000/09/xmldsig#"}).text
